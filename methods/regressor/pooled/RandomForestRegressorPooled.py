...
class RandomForestRegressorPooled(BaseMTLEstimator):
    """
    ...
    def __init__(self, n_estimators=10, max_depth=None,
                 ...
                 fit_intercept=True, normalize=False, name='RF-Reg'):
        ...
        self.model = sk.RandomForestRegressor(n_estimators=n_estimators,
                                              max_depth=max_depth,
