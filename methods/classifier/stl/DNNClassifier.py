...
class DNNClassifier(BaseSingleEstimator):
    """
    Implement a Deep-and-Wide Multi-layer Perceptron Classifier with Dropout and
    ...
    def __init__(self, batch_size=100, nb_epochs=100, arch=[10, 10],
                 fit_intercept=True, normalize=False, name='DNNC-STL'):
...
#                                             patience=5, min_lr=0.001)
    ...
    def _create_model(self, input_shape):
        ...
        out = layers.Dense(1, activation='sigmoid')(cat1)
